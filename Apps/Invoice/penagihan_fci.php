...
<body>
                ...
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">
                            <strong>PT. Food Container Indonesia</strong>
                        </li>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox">
                            <div class="ibox-title bg-info">
                                <h5>Tabel Penagihan Berjalan PT. Food Container Indonesia</h5>
    ...
    <script src="DataScript/ptfci.js"></script>
    <script>
        $(document).ready(function() {
            $(document).ready(function() {
                document.getElementById('invfci').setAttribute('class', 'active');
            });
