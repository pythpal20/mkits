...
<body>
                ...
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">
                            <strong>PT. Batavia Adimarga Kencana</strong>
                        </li>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox">
                            <div class="ibox-title bg-info">
                                <h5>Tabel Penagihan Berjalan PT. BATAVIA ADIMARGA KENCANA</h5>
    ...
    <script src="DataScript/ptbak.js"></script>
    <script>
        $(document).ready(function() {
            $(document).ready(function() {
                document.getElementById('invbak').setAttribute('class', 'active');
            });
