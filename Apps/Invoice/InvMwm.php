...
<body>
                ...
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">
                            <strong>CV. Multi Wahana Makmur</strong>
                        </li>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox">
                            <div class="ibox-title bg-info">
                                <h5>Tabel Penagihan Berjalan CV. Multi Wahan Makmur</h5>
    ...
    <script src="DataScript/ptmwm.js"></script>
    <script>
        $(document).ready(function() {
            $(document).ready(function() {
                document.getElementById('invmwm').setAttribute('class', 'active');
            });
