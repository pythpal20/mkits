...
<body>
                ...
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">
                            <strong>PT. Multi Wahana Kencana</strong>
                        </li>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox">
                            <div class="ibox-title bg-info">
                                <h5>Tabel Penagihan Berjalan PT. Multi Wahan Kencana</h5>
                            ...
                            <div class="ibox-content" style="background-color:AliceBlue ;">
                                ...
                                <table class="table table-borderless" id="example" data-toggle="example" data-show-toggle="true" data-show-columns="true" data-id-field="No_Co" data-toolbar="#toolbar" data-show-footer="false" data-show-export="true">
                                    <thead>
                                        <tr>
    ...
    <script src="DataScript/ptmwk.js"></script>
    <script>
        $(document).ready(function() {
            $(document).ready(function() {
                document.getElementById('invmwk').setAttribute('class', 'active');
            });
