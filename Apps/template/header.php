            ...
            <ul class="nav metismenu" id="side-menu">
                    ...
                    <li id="master" class="">
                        ...
                        <ul class="nav nav-second-level">
                            <?php if ($data['level'] != 'sales') { ?>
                                ...
                                <li id="bundlePromotion"><a href="promoBundling.php">Promo</a></li>
                                <li id="komplainform"><a href="datakomplain.php">Komplain <span class="label label-warning float-right">New!</span></a></li>
                            <?php } else if ($data['level'] == 'sales') { ?>
                                <li id="mastercustomer"><a href="customerview_sales.php">My Customer</a></li>
                                <li id="komplainform"><a href="salescomplain.php">Komplain <span class="label label-warning float-right">New!</span></a></li>
                            <?php } ?>
                    ...
                    <li id="penagihan">
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                ...
                                <ul class="nav nav-third-level">
                                    <li id="invmwk"><a href="Invoice/InvMwk.php">PT. MWK</a></li>
                                    <li id="invmwm"><a href="Invoice/InvMwm.php">PT. MWM</a></li>
                                    <li id="invbak"><a href="Invoice/InvBak.php">PT. BAK</a></li>
                                    <li id="invfci"><a href="Invoice/InvFci.php">PT. FCI</a></li>
                                    <li id="invdtm"><a href="Invoice/InvDtm.php">PT. DTM</a></li>
                                </ul>
                            </li>
                ...
                <?php if ($data['modul'] == '3') { ?>
                    ...
                    <li id="penagihan">
                        <a href="list_penagihan.php"><i class="fa fa-dollar"></i> <span class="nav-label">Penagihan </span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li id="invmwk"><a href="Invoice/penagihan_mwk.php">PT. MWK</a></li>
                            <li id="invmwm"><a href="Invoice/penagihan_mwm.php">PT. MWM</a></li>
                            <li id="invbak"><a href="Invoice/penagihan_bak.php">PT. BAK</a></li>
                            <li id="invfci"><a href="Invoice/penagihan_fci.php">PT. FCI</a></li>
                            <li id="invdtm"><a href="Invoice/penagihan_dtm.php">PT. DTM</a></li>
                        </ul>
                    </li>
                    <!-- menu kunjungan -->
                    <?php if ($data['level'] == 'admin' || $data['level'] == 'superadmin') { ?>
                ...
                <?php if ($data['modul'] == '5') { ?>
                    ...
                    <li id="delivery" class="">
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="#">CO Delivery<span class="fa arrow"></span></a>
                                <ul class="nav nav-third-level">
                                    <li id="dsales"><a href="codev_sales.php">Sales & Marketing</a></li>
                                    <li id="dmarketplace"><a href="codev_marketplace.php">Marketplace</a></li>
                                    <li id="dtoko"><a href="codev_showroom.php">Showroom</a></li>
                                    <?php if($data['level'] == 'superadmin') : ?>
                                    <li id="dinternal"><a href="codev_intern.php">Internal</a></li>
                                    <?php endif; ?>
                                </ul>
                            </li>
                            <li id="table_co_deliv">
