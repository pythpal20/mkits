                    ...
                    $('.keepstock').click(function() {
                        ...
                        if (status == "edit") {
                            ...
                            if (total_hitung <= qty_req && parseInt(jml_req) >
                                ...
                                $(this).html("Tidak Disiapkan");
                                setTimeout(() => {
                                    $.ajax({
                                        url: 'modal_agil/updateKeepBatal.php',
                                        method: 'post',
                                        data: {
                                            "qty_keep": jml_req,
                                            "qty_req": qty_req,
                                ...
                                alert('Silahkan hubungi admin sales by WA');
                                $(this).removeClass("btn-danger");
                                $(this).addClass("btn-warning");
                                $(this).html("Tunggu Proses Batal");
                                setTimeout(() => {
                                    $.ajax({
                                        url: 'modal_agil/updateNotifbatal.php',
                                        method: 'post',
                                        data: {
                                            "notif": '1',
                                            "noso": noso,
