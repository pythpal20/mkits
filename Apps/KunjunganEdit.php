            ...
            <div class="row border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="kunjungan.php">Data Kunjungan</a>
                        </li>
                        <li class="breadcrumb-item active">
                            <strong>Edit Kunjungan</strong>
                        </li>
                    </ol>
                </div>
            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" id="idfu" name="idfu" value="<?= $_GET['id'] ?>">
                                                <select id="customer" class="form-control" name="customer"
                                                    data-placeholder="Pilih Customer ..." tabindex="2" required>
                                                    <option value="<?= $rw['customer_id']?>"><?= $rw['customer_nama'] ?>
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <select name="jenis" id="jenis" class="form-control selectjenis"
                                                    required="">
                                                    <option value="<?= $rw['followup_by']?>"><?= $rw['followup_by']?>
                                                    </option>
                                            ...
                                            <div class="form-group" id="data_1">
                                                ...
                                                <div class="input-group date">
                                                    <span class="input-group-addon"><i
                                                        ...
                                                        required
                                                        value="<?= date_format(date_create($rw['tgl_followup']), 'm/d/Y') ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-5">
                                            <div class="form-group">
                                                ...
                                                <select name="salest" id="salest" class="form-control">
                                                    <option value="<?= $rw['user_id'] ?>"><?= $rw['user_nama'] ?>
                                                    </option>
                                                    <?php
                                        ...
                                        <div class=" col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <select name="ket" id="ket" class="form-control" required>
                                                    <option value="<?= $rw['ket'] ?>"><?= $rw['ket'] ?></option>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" style="height: 75px;" name="deskripsi"
                                                    id="deskripsi"
                                                    placeholder="Tulis keterangan . . ."><?= $rw['deskripsi_followup']?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <button class="btn btn-success simpan"><span
