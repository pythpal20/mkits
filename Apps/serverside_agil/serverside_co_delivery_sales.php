...
$columns = array(
    ...
    array( 'db' => 'No_Co', 'dt' =>8,  "formatter" => function ($d, $row){
    ...
    array( 'db' => 'sopir', 'dt' => 9 ),
    array( 'db' => 'kenek', 'dt' => 10 ),
    array( 'db' => 'status_delivery', 'dt' => 11, 'formatter' => function( $d, $row ) {
        ...
        $retVal = ( $d !="3" && $data['modul'] == "2" &&  $data['level'] == "admin" ) ? $buttonApprove : $no_approve ;
