<?php
	...
	header('Content-Disposition: attachment; filename=Data PTS aktual '. $awal .' s/d '. $akhir .'.csv');
	...
	// echo "\xEF\xBB\xBF";
		...
		a.keterangan_beli, a.customer_nama, a.alamat, a.kota, b.model, b.qty_aktual, b.harga_aktual, b.amount_aktual, a.sales, a.keterangan
        FROM pts_header a
        JOIN pts_detail_aktual b ON a.idPts = b.idPts
        WHERE a.status LIKE '$sts' AND a.app_admin = '1' AND a.app_akunting = '1' AND a.tgl_create BETWEEN '$awal' AND '$akhir'
