...
<body>
                                    ...
                                    <table class="table table-hover display" id="example" style="width:100%;">
                                        <thead class="table-info">
                                            <tr>
                                                ...
                                                <th class="text-center" style="min-width:110px"> Tanggal Kirim</th>
                                                <th class="text-center" style="min-width:110px"> Tanggal plan</th>
                                                <th class="text-center" style="min-width:110px" data-priority="1"> SO
                                                </th>
    ...
    $(document).ready(function() {
        document.getElementById('table_co_deliv').setAttribute('class', 'active');
        var buttonView =
        ...
        var table = $('#example').DataTable({
            ...
            "responsive": true,
            "serverSide": true,
            "ajax": "serverside_agil/serverside_co_delivery_sales.php",
            "columnDefs": [{
                    "targets": -1,
