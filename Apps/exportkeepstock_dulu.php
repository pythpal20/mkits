...
<table class="detail" style="border:1px solid;border-collapse: collapse;page-break-after: always;">
    ...
    <tbody>
        ...
        $html .="<tr>";
            ...
            $html .="<td style='text-align:center;'> ".$data['keterangan_qty']."</td>";
...
<table class='label'>
    ...
    $html .="<tr>";
        ...
        $html .="<td><p style='font-size:28px;'>".$data3['qty_req']."</p></td>";
        $html .="<td><p style='font-size:28px;'>".$customer."</p></td>";
