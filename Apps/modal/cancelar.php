...
$('#FeedBackForm').on("submit", function(event) {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            var text = "CANCEL PO " + nopo + " FEEDBACK : " + textFeedback +
                " | Cancel By : <?php echo $data['user_nama'];?>  " + " | PO By sales : " + sales;
            setTimeout(function() {
                $.ajax({
                    url: url,
                    method: "get",
...
if(isset($_POST['id']))
{
    ...
    <br>';
    $output .= '<input type="submit" name="update" id="update" value="Cancel PO" class="btn btn-danger" />
    </form>';
    echo $output;
}
