            ...
            <tbody style="background-color:white;overflow-x: scroll;">
                <div class="responsive">
                    <tr>
                        ...
                        <td style="min-width:110px" class="text-center ">
                            <input type="number" style="font-family: Verdana;" class="form-control text-center"
                                id="price_<?=$no;?>" name="price" value="<?php echo $dtl['price']; ?>" readonly>
                        </td>
                        <td style="min-width:110px" class="text-center">
                            <input type="number" class="form-control text-center" style="font-family: Verdana;"
                        ...
                        <td style="min-width:140px" class="text-center"><input type="number"
...
<div class="input-group mt-3">
    ...
    <input type="text" name="kenek" placeholder="pic 2" id="kenek" class="form-control">
</div>
<div class="input-group mt-3">
...
<div class="d-none" id="option_alasan">
    <select class="form-control  m-t" name="alasan" id="alasan">
        ...
        <option value="4">Toko Tutup</option>
...
<button type="button" class="btn btn-primary float-right kirim">Kirim
</button>
<tr></tr>