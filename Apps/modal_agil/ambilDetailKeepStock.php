...
<div style="width:100%;overflow-x:auto">
    ...
    function button($status, $status_notif){
        ...
        $tButton = "";
         ...
         if ($status == "1") {
            if ($status_notif == '1' && $moduluser =="4") {
                # code...
                $classButton = "btn-danger sudahnotif";
                $textButton = "Req Batal"; 
            } else if ($moduluser =="1" && $status_notif == "0"){
                # code...
                $classButton = "btn-danger";
                $textButton = "Batalkan Request";
            }
             else if ($moduluser == "4" ){
                # code...
                $classButton = "btn-success disabled";
                $textButton = "Sedang Req Batal";
             }else{
        ...
        ?>
            <tr>
                ...
                <td class="text-center" style="min-width:180px;">
                    ...
                    <!--<?php if($akses == "1" && $leveluser == "admin" || $leveluser == "superadmin" && $dtl['status_keep'] =="1" && $dtl['notif'] =="0"):?>-->
                    <!--<input type="hidden" placeholder='qty' value="<?php echo $dtl['qty_req']; ?>"-->
                    <!--    id='input_<?=$dtl['id'];?>' class="form-control" disabled>-->
                    <!--<button type="button"-->
                    <!--    class="btn <?php echo button($dtl['status_keep'],$dtl['notif'])['classButton'];?> keepstock "-->
