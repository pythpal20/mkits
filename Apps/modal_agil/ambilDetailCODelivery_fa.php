<?php
    ...
    $query = "SELECT a.noso,a.alasan, a.No_Co,a.sales, c.customer_nama,d.term, a.sales, a.no_bl, a.no_fa, a.no_sh,  a.alamat_krm 
    ...
    <table class="table">
        <thead class=" table-info ">
            <tr class=" text-center">
                ...
                <th style="min-width:180px"> Gudang</th>
            </tr>
        </thead>
    </table>
            ...
            <tbody style="background-color:white;overflow-x: scroll;">
                <div class="responsive">
                    <tr>
                        ...
                        <td style="min-width:140px" class="text-center"><input type="text"
                        ...
                        <td style="min-width:180px" class="text-center align-middle">
                            ...
                            <label for="" class="label label-secondary ">Close</label></br>
                            <?php }?>
                        </td>
                    </tr>
                </div>
