...
<body>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox">
                            ...
                            <div class="ibox-content">
                                <table class="stripe row-border order-column" width="100%" id="TBilling">
                                    <thead>
                                        <tr>
                                            <th>No. SCO</th>
                                            <th>PT.</th>
    ...
    //dataTable Script
    $(document).ready(function() {
        var table = $('#TBilling').DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": "../serverside/Billing.php",
            "scrollY": 400,
            "scrollX": true,
            "scrollCollapse": true,
            "paging": true,
