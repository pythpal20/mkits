...
<body>
    ...
    $(document).ready(function() {
        ...
        var table = $('#tblDso').DataTable({
            ...
            "responsive": true,
            "serverSide": true,
            "ajax": "../serverside/delivery_comwk.php?id=" + 3,
            "columnDefs": [{
                    "targets": -1,
    ...
    $(document).ready(function() {
        ...
        var tablem = $('#tbmarketplace').DataTable({
            ...
            "responsive": true,
            "serverSide": true,
            "ajax": "../serverside/delivery_comwm.php?id=" + 3,
            "columnDefs": [{
                    "targets": -1,
                    "responsivePriority": 1,
                    "data": null,
    ...
    $(document).ready(function() {
        ...
        var tabletoko = $('#tbshowroom').DataTable({
            ...
            "responsive": true,
            "serverSide": true,
            "ajax": "../serverside/delivery_codtm.php?id=" + 3,
            "columnDefs": [{
                    "targets": -1,
                    "responsivePriority": 1,
                    "data": null,
    ...
    $(document).ready(function() {
        ...
        var tabletoko = $('#tbinternal').DataTable({
            ...
            "responsive": true,
            "serverSide": true,
            "ajax": "../serverside/delivery_cobak.php?id=" + 3,
            "columnDefs": [{
                    "targets": -1,
                    "responsivePriority": 1,
                    "data": null,
    ...
    $(document).ready(function() {
        ...
        var tabletoko = $('#tbfci').DataTable({
            ...
            "responsive": true,
            "serverSide": true,
            "ajax": "../serverside/delivery_cofci.php?id=" + 3,
            "columnDefs": [{
                    "targets": -1,
                    "responsivePriority": 1,
                    "data": null,
