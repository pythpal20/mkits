...
$table = <<<EOT
 (
    ...
    WHERE NOT EXISTS (SELECT * FROM customerorder_hdr_delivery d WHERE a.No_Co = d.No_Co) AND ($where) AND YEAR(a.tgl_krm)>'2021' AND a.status = '1' AND a.id_perusahaan ='1'
    GROUP BY b.No_Co
